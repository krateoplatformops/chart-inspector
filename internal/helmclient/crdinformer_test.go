...
func TestStartCRDInformerWithClientset_Add_Update_Delete_InvokeInvalidate(t *testing.T) {
	...
	if err := StartCRDInformerWithClientset(ctx, fakeClient, invalidator, slog.Default()); err != nil {
